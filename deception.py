from intention import ws_S_intends_to_bring_about_D_T, bg_S_intends_to_bring_about_D_T, bg_S_intends_to_cause
...
def bg_S_deceives_T(game: bet_game, Q, Q_ref, setting, PSO=False) -> bool:
    ...
    S_intends = bg_S_intends_to_cause(game, Q, Q_ref, (x,y), PSO=PSO)
...
def bg_S_is_deceptive(game: bet_game, Q, Q_ref, PSO=False) -> bool:
    ...
    #    if bg_S_deceives_T(game, Q, Q_ref, setting, PSO=PSO):
    #        return True
    #return False
